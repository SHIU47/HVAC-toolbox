...
DTC.buildFanWalls = function() {
    ...
    FW.slotZs.forEach((cz, slotIdx) => {
        ...
        if (isInstalled) {
            ...
            addLocalInstancedMesh(highDetailGroup, box1, this.materials.filterFrameMat, filterFrameMatrices);
            ...
            cols.forEach(fz => {
                ...
                highDetailGroup.add(pClone);
            });

            // 集風罩與馬達零件實例化
            addLocalInstancedMesh(highDetailGroup, venturiGeo, this.materials.fanwallTrim, venturiMatrices);
            addLocalInstancedMesh(highDetailGroup, spiderArmGeo, this.materials.fanwallTrim, spiderArmMatrices);
            addLocalInstancedMesh(highDetailGroup, motorBodyGeo, this.materials.ecFanBlue, motorBodyMatrices); // 採用 EC 專用工業藍色電機殼
            addLocalInstancedMesh(highDetailGroup, motorRearCoverGeo, this.materials.fanwallCasing, motorBodyMatrices);
            addLocalInstancedMesh(highDetailGroup, motorFinGeo, this.materials.fanwallTrim, motorFinMatrices);
            addLocalInstancedMesh(highDetailGroup, terminalBoxGeo, this.materials.fanwallCasing, terminalBoxMatrices);
            addLocalInstancedMesh(highDetailGroup, cableGlandGeo, this.materials.brassMat, cableGlandMatrices);
            addLocalInstancedMesh(highDetailGroup, ledIndicatorGeo, this.materials.fanwallLed, ledIndicatorMatrices);

            // 護網密網格裝配
            addLocalInstancedMesh(highDetailGroup, guardRingGeo, this.materials.fanwallGrille, guardRingMatrices);
            addLocalInstancedMesh(highDetailGroup, guardSpokeGeo, this.materials.fanwallGrille, guardSpokeMatrices);

            // 冷卻盤管系統實例
            addLocalInstancedMesh(highDetailGroup, box1, this.materials.coilFinMat, coilFinMatrices);
            addLocalInstancedMesh(highDetailGroup, pipeGeoHoriz, this.materials.fanwallCopper, coilTubeMatrices);
            addLocalInstancedMesh(highDetailGroup, uBendGeo, this.materials.fanwallCopper, coilUBendMatrices);
