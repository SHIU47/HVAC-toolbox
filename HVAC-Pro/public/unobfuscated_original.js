const APP = {
  ...
  buildPlant() {
    const _0xf475aa = (_0x32807e, _0x25cc91, _0x27d076 = 0.12) => {
      ...
      for (let _0x533099 = 0; _0x533099 < _0x32807e.length - 1; _0x533099++) {
        const _0x36ec36 = new THREE.Vector3(..._0x32807e[_0x533099]);
        const _0x2aeef1 = new THREE.Vector3(..._0x32807e[_0x533099 + 1]);
      ...
      for (let _0x322a7c = 1; _0x322a7c < _0x32807e.length - 1; _0x322a7c++) {
        const _0x5e132b = new THREE.Vector3(..._0x32807e[_0x322a7c]);
      ...
      if (_0x32807e.length >= 2) {
        const _0x362486 = new THREE.CylinderGeometry(_0x27d076 * 1.4, _0x27d076 * 1.4, 0.035, 16);
        const _0x4ba513 = new THREE.Vector3(..._0x32807e[0]);
        const _0x18b697 = new THREE.Vector3(..._0x32807e[1]);
        const _0x47a1c8 = new THREE.Vector3(..._0x32807e[_0x32807e.length - 1]);
        const _0x9b973e = new THREE.Vector3(..._0x32807e[_0x32807e.length - 2]);
    ...
    _0x37fcbd(7.5, -9);
    const _0x3f2bb3 = new THREE.CylinderGeometry(0.2, 0.2, 15, 24);
    const _0x326737 = new THREE.Mesh(_0x3f2bb3, this.materials.pipeCHWS);
    _0x326737.rotation.z = Math.PI / 2;
    _0x326737.position.set(-0.5, 3.2, -11);
    _0x326737.castShadow = true;
    this.scene.add(_0x326737);
    const _0x29c2c2 = new THREE.Mesh(_0x3f2bb3, this.materials.pipeCHWR);
    _0x29c2c2.rotation.z = Math.PI / 2;
    _0x29c2c2.position.set(-0.5, 5.6, -11);
    _0x29c2c2.castShadow = true;
    this.scene.add(_0x29c2c2);
    _0xf475aa([[0.5, 3.2, -11], [0.5, 3.8, -11], [0.5, 3.8, 1.45], [0.5, 0.58, 1.45], [-0.25, 0.58, 1.45]], this.materials.pipeCHWS);
    _0xf475aa([[0.5, 4.4, -6.5], [0.5, 5, -6.5], [0.5, 5, 1.15], [0.5, 0.58, 1.15], [-0.25, 0.58, 1.15]], this.materials.pipeCHWR);
    _0xf475aa([[-0.25, 0.54, 0.85], [0.5, 0.54, 0.85], [0.5, 5, 0.85], [0.5, 5, -8], [0.5, 4.4, -8]], this.materials.pipeCWR);
    _0xf475aa([[0.5, 3.2, -7], [0.5, 3.8, -7], [0.5, 3.8, 0.55], [0.5, 0.54, 0.55], [-0.25, 0.54, 0.55]], this.materials.pipeCWS);
    _0xf475aa([[6, 3.2, -11], [6, 3.8, -11], [6, 3.8, 1.45], [6, 0.58, 1.45], [5.25, 0.58, 1.45]], this.materials.pipeCHWS);
    _0xf475aa([[6, 4.4, -6.5], [6, 5, -6.5], [6, 5, 1.15], [6, 0.58, 1.15], [5.25, 0.58, 1.15]], this.materials.pipeCHWR);
    _0xf475aa([[5.25, 0.54, 0.85], [6, 0.54, 0.85], [6, 5, 0.85], [6, 5, -8], [6, 4.4, -8]], this.materials.pipeCWR);
    _0xf475aa([[6, 3.2, -7], [6, 3.8, -7], [6, 3.8, 0.55], [6, 0.54, 0.55], [5.25, 0.54, 0.55]], this.materials.pipeCWS);
    [-6.5, -5, -3.5].forEach(_0x572d83 => {
      _0xf475aa([[_0x572d83, 5.6, -11], [_0x572d83, 5, -11], [_0x572d83, 5, -4.5], [_0x572d83, 0.32, -4.5], [_0x572d83, 0.32, -6.15]], this.materials.pipeCHWR);
    });
    [-6.5, -5, -3.5].forEach(_0x428ec2 => {
      _0xf475aa([[_0x428ec2, 1.21, -6.7], [_0x428ec2, 4.4, -6.7], [_0x428ec2, 4.4, -6.5]], this.materials.pipeCHWR);
    });
    _0xf475aa([[-6.5, 4.4, -6.5], [7.3, 4.4, -6.5]], this.materials.pipeCHWR);
    [1.5, 3, 4.5].forEach(_0x18a2c9 => {
      _0xf475aa([[_0x18a2c9, 5.6, -9], [_0x18a2c9, 5, -9], [_0x18a2c9, 5, -4.5], [_0x18a2c9, 0.32, -4.5], [_0x18a2c9, 0.32, -6.15]], this.materials.pipeCWS);
    });
    [1.5, 3, 4.5].forEach(_0x4f0117 => {
      _0xf475aa([[_0x4f0117, 1.21, -6.7], [_0x4f0117, 3.2, -6.7], [_0x4f0117, 3.2, -7]], this.materials.pipeCWS);
    });
    _0xf475aa([[-0.5, 3.2, -7], [6, 3.2, -7]], this.materials.pipeCWS);
    _0xf475aa([[1.5, 5.6, -9], [5.7, 5.6, -9]], this.materials.pipeCWS);
    _0xf475aa([[-0.5, 4.4, -8], [6, 4.4, -8]], this.materials.pipeCWR);
    _0xf475aa([[7.3, 3.2, -11], [7.3, 3.8, -11], [7.3, 3.8, -7.5], [7.3, 1.12, -7.5], [7.3, 1.12, -8.26]], this.materials.pipeCHWS);
    _0xf475aa([[7.3, 0.44, -8.26], [7.3, 0.44, -6.5], [7.3, 4.4, -6.5]], this.materials.pipeCHWR);
    const _0x5ca748 = new THREE.CylinderGeometry(0.18, 0.18, 0.3, 16);
    const _0xe8dfbe = new THREE.Mesh(_0x5ca748, this.materials.darkMetal);
    _0xe8dfbe.rotation.x = Math.PI / 2;
    _0xe8dfbe.position.set(1.5, 5, -13);
    this.scene.add(_0xe8dfbe);
    const _0x468aa2 = new THREE.Mesh(_0x5ca748, this.materials.darkMetal);
    _0x468aa2.rotation.x = Math.PI / 2;
    _0x468aa2.position.set(2, 5, -13);
    this.scene.add(_0x468aa2);
    _0xf475aa([[2, 4.4, -8], [2, 5, -8], [2, 5, -13.5], [2, 10.3, -13.5], [-2.3, 10.3, -13.5], [-2.3, 10.3, -16]], this.materials.pipeCWR);
    _0xf475aa([[2, 10.3, -13.5], [2.2, 10.3, -13.5], [2.2, 10.3, -16]], this.materials.pipeCWR);
    _0xf475aa([[-2.3, 8.3, -16], [-2.3, 8.3, -14], [1.5, 8.3, -14], [1.5, 5, -14], [1.5, 5, -9], [1.5, 5.6, -9]], this.materials.pipeCWS);
    _0xf475aa([[2.2, 8.3, -16], [2.2, 8.3, -14], [1.5, 8.3, -14]], this.materials.pipeCWS);
    ...
    _0xf475aa([[-9, 0.82, -7.3], [-9, 0.82, -11], [-7, 0.82, -11], [-7, 4.5, -11]], this.materials.pipeCHWR, 0.06);
  },
  updateLiveValues() {
  ...
  onMouseMove(_0x2c2a30) {
    ...
    const _0x359eed = this.raycaster.intersectObjects(this.interactables);
  ...
  onClick(_0x3c67ba) {
    this.raycaster.setFromCamera(this.mouse, this.camera);
    const _0x4fba77 = this.raycaster.intersectObjects(this.interactables);
  ...
  toggleLeftHud() {
    ...
    document.getElementById("hud-left").classList.toggle("active", this.leftHudVisible);
  },
  toggleSimPanel() {
  ...
  setCamera(_0x164c86) {
    ...
    if (_0x164c86 === "overview") {
      ...
      _0x4e99ef = new THREE.Vector3(5, 6, -12);
      _0x4cadfe = new THREE.Vector3(-1.5, 2, -17);
    }
  ...
  tweenCamera(_0x161694, _0x54db51) {
    if (window.TWEEN) {
      new TWEEN.Tween(this.camera.position).to(_0x161694, 1500).easing(TWEEN.Easing.Cubic.InOut).start();
      new TWEEN.Tween(this.controls.target).to(_0x54db51, 1500).easing(TWEEN.Easing.Cubic.InOut).start();
    } else {
  ...
  animate() {
    ...
    const _0x472d58 = this.clock.getElapsedTime();
    this.pipeMaterials.forEach(_0x27f2f1 => {
      if (_0x27f2f1.map) {
        _0x27f2f1.map.offset.y = -_0x472d58 * 0.5;
      }
    });
